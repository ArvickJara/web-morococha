...
/**
 * Logger personalizado para Morococha
 * Crea archivos de log organizados por día en la carpeta log-morococha
 */
class Logger {
  constructor() {
    this.logDir = path.join(__dirname, '..', 'log-morococha');
  ...
  getLogFilePath() {
    ...
    const logFileName = `morococha-${dateStr}.log`;
