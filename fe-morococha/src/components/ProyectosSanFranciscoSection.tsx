...
const ProyectosSanFranciscoSection = () => {
  const [proyectos, setProyectos] = useState<ProyectoSF[]>([]);
  ...
  const fetchProyectos = () => {
    let query = `/proyectos-san-franciscos?populate[media][fields][0]=url&populate[media][fields][1]=name&sort=publishedAt:desc&pagination[page]=${page}&pagination[pageSize]=5`;
    ...
    api
      .get<{ data: ProyectoSF[]; meta: { pagination: { pageCount: number } } }>(
        query
      )
      .then((res) => {
      ...
      .catch((err) => {
        console.error("Error cargando proyectos San Francisco", err);
      });
  };
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-2">
            Proyectos San Francisco de Asís de Pucará
          </h2>
          <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
            Conoce los proyectos en planificación, ejecución y concluidos de la
            comunidad San Francisco de Asís de Pucará.
          </p>
        </div>
...
export default ProyectosSanFranciscoSection;
